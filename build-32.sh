...
build_project riscv-isa-sim --prefix=$RISCV --with-fesvr=$RISCV --with-isa=rv32imafdc
build_project riscv-gnu-toolchain --prefix=$RISCV --with-arch=rv32imafdc --with-abi=ilp32d
